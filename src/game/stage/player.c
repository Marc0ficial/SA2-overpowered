...
#define GET_ROTATED_ACCEL(angle)   ((SIN_24_8((angle)*9) * 10) >> 11)
#define GET_ROTATED_ACCEL_2(angle) ((SIN_24_8((angle)*9) * 11) >> 11)
#define GET_ROTATED_ACCEL_3(angle) ((SIN_24_8((angle)*9) * 80))
